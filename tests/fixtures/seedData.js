...
exports.seedDataSummary = exports.seedExpenses = exports.seedPayments = exports.seedInvoices = exports.seedVisits = exports.seedPatientPackages = exports.seedServices = exports.seedPackages = exports.seedPatients = exports.seedDoctors = void 0;
...
exports.seedDataSummary = {
    doctors: exports.seedDoctors.length,
    patients: exports.seedPatients.length,
    packages: exports.seedPackages.length,
    patientPackages: exports.seedPatientPackages.length,
    visits: exports.seedVisits.length,
    invoices: exports.seedInvoices.length,
    payments: exports.seedPayments.length,
    expenses: exports.seedExpenses.length,
    additionalServices: exports.seedServices.length,
};
